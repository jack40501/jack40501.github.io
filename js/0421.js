...
function off() {
    document.getElementById('shop' + y).style.visibility = 'hidden'
    document.getElementById('shop' + y).style.width = '0'
    document.getElementById('shop' + y).style.height = '0'
    y += -1
}
function showalert1() {
    ...
    for (i = 0; i < 4; i++) {
        ...
        document.getElementById('shop' + y).innerHTML = '<div class="row">' + '<div class="col-md-6">' + '<img src=img/' + x + '.png>' + '</div>' + m + '<br></br>' + '數量' + g + '</div>';
